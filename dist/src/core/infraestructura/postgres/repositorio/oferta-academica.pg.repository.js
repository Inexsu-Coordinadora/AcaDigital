...
export class OfertaAcademicaPGRepositorio {
    mapearFilaAOferta(fila) {
        return new OfertaAcademica(fila.periodo_id, fila.programa_id, fila.asignatura_id, fila.grupo, fila.cupo_disponible, fila.id, new Date(fila.created_at), new Date(fila.updated_at));
    }
    async guardar(oferta) {
        const sql = `
    ...
    async buscarPorClaveUnica(periodoId, programaId, asignaturaId, grupo) {
        const sql = `
...
//# sourceMappingURL=oferta-academica.pg.repository.js.map