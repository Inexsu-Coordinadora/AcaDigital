...
export default async function rutasProgramaAcademico(instance, options) {
    const { crearProgramaAcademicoUseCase, listarProgramasAcademicosUseCase, obtenerProgramaAcademicoUseCase, actualizarProgramaAcademicoUseCase, eliminarProgramaAcademicoUseCase, } = options.dependencies;
    ...
    instance.post('/', {
        ...
        const programaCreado = await crearProgramaAcademicoUseCase.execute(request.body);
    ...
    instance.put('/:programaId', {
        ...
        const { programaId } = request.params;
        const programaActualizado = await actualizarProgramaAcademicoUseCase.execute(programaId, request.body);
...
//# sourceMappingURL=programa-academico.rutas.js.map