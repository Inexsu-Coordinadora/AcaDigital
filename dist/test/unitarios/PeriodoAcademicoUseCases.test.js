...
import { ErrorAplicacion, ErrorConflicto } from '../../src/core/errores/ErrorAplicacion.js';
...
describe('Pruebas Básicas de Período Académico', () => {
    ...
    describe('CrearPeriodoUseCase', () => {
        ...
        it('Debe crear un período si los datos son válidos y no hay otro con el mismo nombre', async () => {
            ...
            mockPeriodoRepositorio.obtenerPorNombre.mockResolvedValue(null);
            mockPeriodoRepositorio.guardar.mockImplementation(periodo => Promise.resolve(periodo));
        ...
        it('Debe fallar si ya existe un período con el mismo nombre', async () => {
            ...
            mockPeriodoRepositorio.obtenerPorNombre.mockResolvedValue(periodoExistente);
    ...
    describe('ActualizarPeriodoUseCase', () => {
        ...
        it('Debe actualizar un período existente con éxito', async () => {
            ...
            mockPeriodoRepositorio.obtenerPorId.mockResolvedValue(periodoEncontrado);
            mockPeriodoRepositorio.obtenerPorNombre.mockResolvedValue(null);
            mockPeriodoRepositorio.actualizar.mockResolvedValue(true);
            await actualizarPeriodoUseCase.ejecutar(idExistente, input);
            expect(mockPeriodoRepositorio.actualizar).toHaveBeenCalledWith(idExistente, expect.objectContaining({ nombre: input.nombre }));
        });
        ...
        it('Debe fallar si el período a actualizar no se encuentra', async () => {
            ...
            mockPeriodoRepositorio.obtenerPorId.mockResolvedValue(null);
...
//# sourceMappingURL=PeriodoAcademicoUseCases.test.js.map