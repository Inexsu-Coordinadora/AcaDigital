import { CrearAsignaturaUseCase, EliminarAsignaturaUseCase, ObtenerAsignaturaPorIdUseCase, ObtenerAsignaturasUseCase, ActualizarAsignaturaUseCase } from '../../src/core/aplicaciones/asignatura/index.js';
...
import { TipoAsignatura } from '../../src/core/dominio/entidades/asignatura/Asignatura.js';
import { ErrorConflicto, ErrorNoEncontrado } from '../../src/core/errores/ErrorAplicacion.js';
let repositorio;
let crearUseCase;
let eliminarUseCase;
let obtenerPorIdUseCase;
let actualizarUseCase;
let obtenerTodosUseCase;
const DTO_CREACION = {
    nombre: 'Estructura de Datos',
    cargaHoraria: 6,
    tipo: TipoAsignatura.PRACTICA,
};
const DTO_CREACION_2 = {
...
//# sourceMappingURL=Asignatura.integration.test.js.map