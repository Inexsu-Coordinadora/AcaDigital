...
const PeriodoAcademicoBodyModel = {
    type: 'object',
    properties: {
        nombre: { type: 'string', description: 'Nombre del período (ej. 2025-1)' },
...
export function registerPeriodoAcademicoRoutes(
    ...
    server.post('/', {
        schema: {
            ...
            response: {
                201: {
                    ...
                    ...PeriodoAcademicoResponseModel
                },
                400: {
                    description: 'Error de validación (ej. fechas inválidas)',
                    ...ErrorResponse
                },
                409: {
                    description: 'Error de solapamiento de fechas con otro período existente',
                    ...ErrorResponse
                }
            }
        }
        ...
        try {
            ...
            reply.code(error.message.includes('solapamiento') ? 409 : 400).send({ message: error.message });
        }
    });
    ...
    server.get('/', {
        schema: {
            ...
            description: 'Obtiene una lista de todos los períodos académicos registrados.',
            response: {
                200: {
                    type: 'array',
    ...
    server.get<{ Params: Params }>('/:id', {
        ...
        if (!resultado) return reply.code(404).send({ message: 'Período no encontrado' });
        reply.send(resultado);
    });
    ...
    server.put<{ Params: Params }>('/:id', {
        schema: {
            ...
            response: {
                ...
                400: {
                    description: 'Error de validación (ej. fechas, o estados inválidos)',
                    ...ErrorResponse
                },
                404: {
                    description: 'Período no encontrado',
                ...
                409: {
                    description: 'Error de solapamiento de fechas con otro período',
                    ...ErrorResponse
                }
            }
        }
    ...
    server.put<{ Params: Params }>('/:id/error-fecha-invalida', {
        schema: {
            ...
            response: {
                400: {
                    description: 'Error: Las fechas son inconsistentes (fecha fin debe ser posterior a fecha inicio)',
                    ...ErrorResponse
                }
            }
        }
    ...
    server.put<{ Params: Params }>('/:id/error-solapamiento', {
        schema: {
            ...
            response: {
                409: {
                    description: 'Error: El rango de fechas se solapa con otro período activo.',
                    ...ErrorResponse
                }
            }
        }
    ...
    server.put<{ Params: Params }>('/:id/error-transicion', {
        schema: {
            ...
            response: {
                400: {
                    description: 'Error: Transición de estado inválida.',
                    ...ErrorResponse
                }
            }
        }
    ...
    server.delete<{ Params: Params }>('/:id', {
        schema: {
            ...
            response: {
                204: {
                    description: 'Período eliminado exitosamente (sin contenido)'
                },
                400: {
                    description: 'Error de negocio (ej. no se puede eliminar un período activo o con ofertas)',
                    ...ErrorResponse
                },
                404: {
                    description: 'Período no encontrado',
